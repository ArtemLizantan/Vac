  ...
  return filteredProducts.length === 0 ? (
    <div className="error">
      <div className="error__body">
        ...
        <h2 className="error__title">Unfortunately there are no matches for your query.</h2>
        <div className="error__subtitle">Try using other filter settings or request a car of your choice.</div>
        <button onClick={clearAllFilters} className="error__clear">Clear filters</button>
      </div>
    </div>
  ) : (
    <Swiper
